...
/**
 * Attribute filter to evaluate entitlement for access to GOCDB.
 *
 */
class sspmod_entitlement_Auth_Process_GOCDB extends SimpleSAML_Auth_ProcessingFilter
{
    ...
    private $entitlement = array(
        'urn:mace:egi.eu:aai.egi.eu:gocdb',
    ...
    private $idpWhitelist = array(
        ...
        'https://idp01.stfc.ac.uk/shibboleth',
        'https://idp02.stfc.ac.uk/shibboleth',
        // Devel
    ...
    private $entitlementWhitelist = array(
        // Production
        'urn:mace:egi.eu:elixir-europe.org:manager@vo.elixir-europe.org',
        'urn:mace:egi.eu:group:vo.elixir-europe.org:role=manager#elixir-europe.org',
    ...
    private function isQualified($state)
    {
        ...
        SimpleSAML_Logger::debug("[entitlement:GOCDB] IdP="
